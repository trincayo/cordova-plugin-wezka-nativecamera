...
public class NativeCameraLauncher extends CordovaPlugin {
    ...
    private File createCaptureFile() {
        ...
        if (!this.saveToPhotoAlbum) {
            ...
            photo = new File(getTempDirectoryPath(this.cordova.getActivity().getApplicationContext()), "Pic-" + this.date + ".jpg");

        } else {
            photo = new File(getPicutresPath());
    ...
    private String getPicutresPath() {
        ...
        String imageFileName = "funEvent_" + timeStamp + ".jpg";
        File storageDir = Environment.getExternalStoragePublicDirectory(
                Environment.DIRECTORY_PICTURES);
        String galleryPath = storageDir.getAbsolutePath() + "/" + imageFileName;
        this.nameFoto = galleryPath;
        return galleryPath;
    }
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            try {
                ...
                ExifHelper exif = new ExifHelper();
                 ...
                 if (saveToPhotoAlbum){
                     exif.createInFile( this.nameFoto);
                 }else{
                exif.createInFile(getTempDirectoryPath(this.cordova.getActivity().getApplicationContext()) + "/Pic-" + this.date + ".jpg");
                 }
                exif.readExifData();
                rotate = exif.getOrientation();
                Log.i(LOG_TAG, "Rotacion: "+rotate);
